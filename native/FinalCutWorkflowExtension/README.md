...
This directory contains the in-process half of Playhead's live Final Cut Pro
...
`PLAYHEAD_FINAL_CUT_SOCKET`, defaulting to `/tmp/playhead-finalcut.sock`.
...
the containing app and the user must activate Playhead from its Extensions
